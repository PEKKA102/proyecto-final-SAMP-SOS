package com.test.vetcare.ShakeServices;
...
import com.test.vetcare.Contacts.ContactModel;
import com.test.vetcare.Contacts.DbHelper;
import com.test.vetcare.R;
...
public class SensorService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        ...
        throw new UnsupportedOperationException("No se ha implementado todavia");
    }
                            ...
                            if(location!=null){
                               ...
                               SmsManager smsManager = SmsManager.getDefault();
                                ...
                                for(ContactModel c: list){
                                    String message = "Hey, "+c.getName()+"Necesito ayuda, estas son mis coordenadas, venir cuanto antes posible.\n "+"http://maps.google.com/?q=" + location.getLatitude() + "," + location.getLongitude();
                                    smsManager.sendTextMessage(c.getPhoneNo(), null, message, null, null);
                                }
                            }else{
                                String message= "Necesito ayuda,.\n"+"El servicio de GPS no se pudo iniciar,por favor llamar a la estacion de policia mas cercana.";
                                SmsManager smsManager = SmsManager.getDefault();
                                DbHelper db=new DbHelper(SensorService.this);
                                List<ContactModel> list=db.getAllContacts();
                                for(ContactModel c: list){
    ...
    private void startMyOwnForeground()
    {
        ...
        Notification notification = notificationBuilder.setOngoing(true)
                .setContentTitle("Te estamos cuidando =).")
                .setContentText("Estamos aqui para ti")
    ...
    public void onDestroy() {
        ...
        broadcastIntent.setAction("ReiniciarDispositivo");
